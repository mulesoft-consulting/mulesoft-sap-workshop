...
You will create a flow that uses the Database Connector and the https://dejim.s3.amazonaws.com/software/ngdbc.jar[JDBC Driver]. Additionally you will learn how to pass in URL parameters to the SQL Query to select specific records from a table.
