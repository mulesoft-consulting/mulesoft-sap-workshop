...
**W**elcome to the MuleSoft SAP Workshop for Mule 4.x. This workshop consists of a set of guides that will provide you
hands-on experience with connecting with SAP using a variety of methods provided through the Anypoint Platform.
In order to complete these guides, you'll need a copy of Anypoint Studio 7.x which is free to https://www.mulesoft.com/lp/dl/studio[download] and install on your Windows, Mac, or Linux machine.

You can click on any of the items below to get started or read up more about integration options with MuleSoft on the Overview page.

This guide will walk you through the process of connecting with an SAP Hana Database.

image:DBConnectorImage.png[]

This guide will walk you through connecting with SAP using the SAP Connector which leverages the SAP JCo Library.

image:SAPConnector.png[]
...
Reminder: The SAP Connector guide requires the use of your own SAP instance. If you don’t have one, you can leverage a hosted SAP service. For the purposes of this guide, we utilized Sandbox SAP.

https://www.idesremote.com
...
|=================================
|Method|Description|Approach
|Database / HANA Database|Direct calls to SAP database.|* Use Database Connector +
* Not recommended +
* Mule can either connect from Anypoint VPC in CloudHub or be co-located near SAP instance. +
* MuleSoft can easily interact with data in SAP DB / HANA DB using the Database Connector +
* All that is required is the HANA JDBC driver +
...
* Current investment in BAPI and IDoc
* NetWeaver Gateway direction
...
* Development lead time for changes / additions on SAP - i.e. custom BAPI development
